 ...
 */
public class RSAlulia extends ListActivity {
    ...
    private void tampilkanpilihanrs(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                i.putExtra(SearchManager.QUERY,"RS Aulia");
